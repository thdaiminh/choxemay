...
class Database
{
    ...
    {
        $this->link = mysqli_connect("localhost","root","","choxemay") or die ();
    ...
    public  function fetchJones($table,$sql)
    {
...
//    }
    ...
    public  function fetchJone($table,$sql)
    {
...
//    public function replace($table1,$table2)
//    {
